...
export default function Hero() {
  return (
    ...
    >
      <div
        aria-hidden
        className="pointer-events-none absolute -top-24 right-[-10%] h-[36rem] w-[36rem] rounded-full bg-primary/10 blur-3xl"
      />
      <div
        aria-hidden
        className="pointer-events-none absolute bottom-[-8rem] left-[-8rem] h-[28rem] w-[28rem] rounded-full bg-accent/10 blur-3xl"
      />
      ...
      <div className="relative mx-auto max-w-6xl grid gap-12 lg:grid-cols-[1.1fr_0.9fr] items-center">
        <div>
          ...
          <h1 className="font-display font-bold text-[2.75rem] sm:text-6xl lg:text-[3.75rem] leading-[1.05] tracking-tight text-foreground mb-6">
            Cleared with care.
            <br />
            <span className="text-primary">Nothing good goes to waste.</span>
          </h1>
          ...
          <div className="flex flex-wrap gap-4">
            <a
              href="#contact"
              className="inline-flex items-center rounded-xl bg-primary px-7 py-4 text-sm font-semibold text-white shadow-[0_8px_24px_rgba(21,128,61,0.35)] hover:bg-primary-light transition-colors"
            >
              Get a Free Quote
            </a>
            <a
              href="#services"
              className="inline-flex items-center rounded-xl border-2 border-foreground/15 px-7 py-4 text-sm font-semibold text-foreground hover:border-primary hover:text-primary transition-colors"
            >
              Our Services
            </a>
          </div>
        ...
        <Reveal className="relative">
          ...
          <div className="absolute -bottom-5 -left-5 flex items-center gap-3 rounded-2xl border border-line bg-white/80 backdrop-blur-md px-5 py-4 shadow-[0_10px_30px_rgba(18,43,32,0.12)]">
